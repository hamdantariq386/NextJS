...
export default function Home() {
  ...
  const [todoData, setTodoData] = useState([]);
      ...
      //pass as a props to the todo component
  ...
  return (
    <>
      ...
      <form onSubmit={onSubmitHandler} className="flex items-start flex-col gap-2 max-w-[600px] mt-24 px-2 mx-auto">
